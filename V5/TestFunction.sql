...
DECLARE @MeAgentId AS UNIQUEIDENTIFIER=(SELECT TOP 1 AgentId FROM Agent AG LEFT JOIN Workplace AS W WITH(NOLOCK)  ON AG.WorkplaceId = W.WorkplaceId
...
EXEC FSC_Backup_Table 'DataQuery',''
EXEC FSC_Backup_Table 'DataQueryColumn',''
EXEC FSC_Backup_Table 'Gateway',''
