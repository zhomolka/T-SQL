...
SELECT DISTINCT TOP 100000 
	  ...
	  ,CAE.InboundCallId
	  ,IC.CallResult
	  ,PT.DisplayName AS PilotName
	  ,IIF(PT.IsIvrTarget=1,'Ano','Ne') AS ExtIVR
  ...
  LEFT JOIN (SELECT 
   ...
   FROM .[dbo].[CallEvent] CAE
  WHERE 1=1
	AND CAE.EventType LIKE 'IvrScript%'
	...
	LEFT JOIN .[dbo].[Pilot] PT ON IC.Pilotid=PT.Pilotid
  WHERE 1=1
