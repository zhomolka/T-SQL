...
/****** Object:  UserDefinedFunction [dbo].[FSC_rep_IVR_HolidayCheck]    Script Date: 14.12.2023 8:32:08 ******/
SET ANSI_NULLS ON
GO
...
-- ======================================================
CREATE FUNCTION [dbo].[FSC_rep_IVR_HolidayCheck]
(	
...
cast(case when [Action] = 'Holiday' then .[dbo].[FSC_HolidayGroupCheck](Numbers,@MyDateTime) else NULL end as bit) as HolidayGroupCheck
