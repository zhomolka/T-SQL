...
/****** Object:  UserDefinedFunction [dbo].[rep_inboundCalls_Stat]    Script Date: 1/4/2019 2:34:52 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT 		-- Příchozí hovory											
		...
		, IIF(AnswerTime > @From AND AnswerTime <= @To AND ChainingId IS NOT NULL,1,0) AS TransferedINCalls 
